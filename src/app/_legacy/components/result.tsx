"use client";
import { Answer } from "@/app/_legacy/components/answer";
// import { Relates } from "@/app/components/relates";
import { Sources } from "@/app/_legacy/components/sources";
import { Relate } from "@/app/_legacy/interfaces/relate";
import { Source } from "@/app/_legacy/interfaces/source";
import { parseRAG } from "@/app/_legacy/utils/parse-rag";
...
export const Result: FC<{
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      />
      <Sources sources={sources} token={token} rewrite={rewrite} />
      {/* {error && (
